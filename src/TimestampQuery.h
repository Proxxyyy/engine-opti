...
#define PROFILE_GPU(name_expr)                                                                                         \
    auto CREATE_UNIQUE_NAME_WITH_PREFIX(gpu_prof) =                                                                    \
            ::OM3D::ScopeGuard([zone_id = ::OM3D::profile::begin_profile_zone(name_expr)]                              \
                               { ::OM3D::profile::end_profile_zone(zone_id); })
