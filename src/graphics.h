...
namespace OM3D
{
    ...
    public:
        ...
        GLHandle(GLHandle&& other) { swap(other); }
        ...
        void swap(GLHandle& other) { std::swap(_handle, other._handle); }

        u32 get() const { return _handle; }

        bool is_valid() const { return _handle; }
