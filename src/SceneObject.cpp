...
namespace OM3D
{
    ...
    void SceneObject::set_transform(const glm::mat4& tr) { _transform = tr; }

    const glm::mat4& SceneObject::transform() const { return _transform; }

    const std::shared_ptr<StaticMesh>& SceneObject::mesh() const { return _mesh; }
